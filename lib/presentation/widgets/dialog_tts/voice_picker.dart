      ...
      children: [
        Padding(
          ...
          child: Row(
            children: [
              Text(
                AppLocalizations.of(context).uiVOICESINBANK,
                style: TextStyle(
                  fontSize: 11,
            ...
            child: SizedBox(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  hintText: AppLocalizations.of(context).uiSearchVoices,
                  hintStyle: TextStyle(
                    color: Colors.white.withValues(alpha: 0.3),
                    fontSize: 12,
                  ),
          ...
          child: widget.assets.isEmpty
              ? Padding(
                  ...
                  child: Text(
                    AppLocalizations.of(
                      context,
                    ).uiNoVoicesInThisBankAddVoicesInVoiceBank,
                    style: TextStyle(
                      color: Colors.white.withValues(alpha: 0.4),
                      fontSize: 12,
                    ),
              ...
              children: [
                CircleAvatar(
                  ...
                  backgroundImage: hasAvatar
                      ? FileImage(File(asset.avatarPath!))
                      : null,
                  child: hasAvatar
                      ? null
                      : Text(
